...
class EventsInVisitSerializer(serializers.ModelSerializer):
    ...
    def get_date(self, obj):
        visit = Visit.objects.get(pk=self.context['visit_id'])
        event_visit = EventVisit.objects.get(event=obj, visit=visit)
...
class AcceptVisitSerializer(serializers.Serializer):

...
urlpatterns = [
    ...
    path(r'events/signup/<int:pk>/', views.AddEventView.as_view(), name='add-event-to-visit'), # добавление в заявку для пользователя
    ...
    path(r'edit-event-visit/<int:pk>/',views.EditEventVisit.as_view(),name='edit-event-in-visit'),
